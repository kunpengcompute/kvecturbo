...
- KVecTurbo子库代码开源发布，需要通过源代码编译后使用，源代码发布至GitCode上，代码分支版本号为**v1.1.0**。
- KVecTurbo支持千万以上数据集，底库向量数量限制提高。若数值过大，可能因系统内存资源限制导致内存分配操作失败。
...
<td class="cellrowborder" valign="top" width="84.06%" headers="mcps1.1.3.1.2 "><p id="p1519435212217"><a name="p1519435212217"></a><a name="p1519435212217"></a>新增鲲鹏自研的向量检索加速组件KVecTurbo，对接openGauss向量数据库使用。将高维向量量化压缩，快速获取query的近邻，同时使用SIMD指令集加速距离计算。</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="16.96%" headers="mcps1.1.4.1.3 "><p id="p18232175511192"><a name="p18232175511192"></a><a name="p18232175511192"></a>开源仓</p>
</td>
</tr>
</tbody>
</table>
